...
| **2** | **Granite-278m-ft ⊕ BM25 (наш гибрид)** | **0.795** |
...
**превосходит специализированную kazakh-e5** (dense 0.752 > 0.747), а её гибрид
с BM25 (**0.795**) — **#2, выше e5-base**, в 0.013 от вершины. И это на identity-BM25:
с казахским стеммером гибрид, вероятно, берёт #1. Впереди (пока) только референс-гибрид.
