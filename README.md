...
**Итог файнтюна (Шаг е, полный отчёт — [`results/eval_107m_ft_vs_zeroshot.md`](results/eval_107m_ft_vs_zeroshot.md)):**
два раунда. Стабильный значимый прирост на **vocabulary-gap** (0.242 → 0.319–0.322,
p<0.001). Во 2-м раунде (+10.8K синтетики, меньше эпох/LR) **регрессия natural
укрощена**: была значимой (R1: 0.876→0.833, p=0.015), стала незначимой
(R2: →0.852, p=0.111). ALL положительный, но пока не значим (0.617 → 0.628, p=0.176):
natural/inflected у Granite близки к потолку, весь запас роста — в vocab-gap.
Тезис доказан; для значимого ALL — добрать синтетику до ~40K + hard-negatives.
